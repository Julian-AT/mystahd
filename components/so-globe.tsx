    ...
    <div className="flex flex-row items-center justify-center  h-screen md:h-auto relative w-full">
      <div className="max-w-7xl mx-auto w-full relative overflow-hidden h-full md:h-[40rem]">
        <motion.div
          ...
          className="div"
        >
          <h2 className="text-center text-xl md:text-4xl font-bold text-secondary-foreground">
            Best Cheats in the World
          </h2>
          <p className="text-center text-base md:text-lg font-normal text-muted-foreground  max-w-md mx-auto">
            World Wide Instant Delivery, Secure Payment, and Best Cheats in the
            World
          </p>
        </motion.div>
